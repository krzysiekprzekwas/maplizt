    ...
    <main className="min-h-screen" style={{ backgroundColor: "#f8f5ed" }}>
      ...
      <header className="border-b-2 border-[#19191b]">
        <div className="container mx-auto flex justify-between items-center py-4 px-4 md:px-6">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link href="#features" className="font-medium hover:text-[#8d65e3] transition">Features</Link>
            <Link href="#testimonials" className="font-medium hover:text-[#8d65e3] transition">Testimonials</Link>
            <Link href="#pricing" className="font-medium hover:text-[#8d65e3] transition">Pricing</Link>
          </nav>
      ...
      <section id="features" className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-[#f8f5ed] p-6 rounded-lg border-2 border-[#19191b]">
            ...
            {/* Feature 4 */}
            <div className="md:col-span-2 lg:col-span-3 bg-[#f7bdf6]/20 p-6 rounded-lg border-2 border-[#19191b] mt-4">
      ...
      <section id="testimonials" className="py-16" style={{ backgroundColor: "#f8f5ed" }}>
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Testimonial 1 */}
            <div className="bg-white p-6 rounded-lg border-2 border-[#19191b]">
      ...
      <section id="pricing" className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* Free Plan */}
            <div className="bg-[#f8f5ed] p-8 rounded-lg border-2 border-[#19191b]">
            ...
            {/* Pro Plan */}
            <div className="bg-[#8d65e3]/10 p-8 rounded-lg border-2 border-[#19191b] relative">
